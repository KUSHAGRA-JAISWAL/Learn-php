<!--
* @file switch_case.php
* @author KUSHAGRA JAISWAL 
* @date 2022-06-18
* @copyright Copyright (c) 2022
-->

<!-- Program show's the concepts of switch case in php. -->
...
<head>
    ...
    <title><?php echo "switch case"; ?></title>
...
<body>
    ...
    <div class="container my-3">
        <h1>Switch Case in php</h1><br><br>
        <h3>
           $age = 18;<br>
