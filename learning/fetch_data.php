...
<!-- Program show's the concepts of Fetching Data from the database in php. -->
<!doctype html>
<html lang="en">
...
<head>
    ...
    <title><?php echo "fetch through db"; ?></title>
...
<body>
    ...
    <div class="container my-3">
        <h1>Fetching the Data from the database in php.<br><br></h1>
        ...
        <h4>
            ...
            if ($num > 0){
                /*
                it can fetch array of recor one by one.
